...
?>
<div class="member-row" data-name="<?php echo esc_attr( strtolower( $org ) ); ?>" data-tier="<?php echo esc_attr( $tier_slug ); ?>" data-industry="<?php echo esc_attr( $industry_slug ); ?>">
